...
int ShowTaskStruct(ULONG64 Address, uint32_t pid_filter, const char * comm_filter, uint32_t flags)
{
	ULONG64 pid;
	ULONG Offset;
	...
	if (pid_filter != 0 && pid != pid_filter)
		return 0;
	dprintf("*** task pid: %d task_struct: 0x%p\n", pid, Address);

	if(flags & NDX_FLAG_BASIC){
		ShowCharField(Address, "task_struct", "comm");
		Show0nField(Address, "task_struct", "tpid");
		Show0nField(Address, "task_struct", "state");
		Show0nField(Address, "task_struct", "usage");
		Show0xField(Address, "task_struct", "flags");
		Show0nField(Address, "task_struct", "stack_canary");
	}
	if (flags & NDX_FLAG_PROCESS_ATTRIBUTE) {
		Show0nField(Address, "task_struct", "ptrace");
		Show0nField(Address, "task_struct", "exit_state");
		Show0nField(Address, "task_struct", "exit_code");
		Show0nField(Address, "task_struct", "exit_signal");
		ShowPtr64Struct(Address, "task_struct", "mm", "mm_struct");
		GetFieldOffset("task_struct", "mm", &Offset);
		ShowMmStruct(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "active_mm", "mm_struct");
	...
	if (flags & NDX_FLAG_THREAD_ATTRIBUTE) {
		Show0xField(Address, "task_struct", "stack");
		Show0nField(Address, "task_struct", "on_cpu");
		Show0nField(Address, "task_struct", "cpu");
		Show0nField(Address, "task_struct", "wakee_flips");
		Show0nField(Address, "task_struct", "wakee_flip_decay_ts");
		...
		ShowPtr64Struct(Address, "task_struct", "last_wakee", "task_struct");
	...
	if (flags & NDX_FLAG_SCHEDULE_ATTRINUTE) {
		Show0nField(Address, "task_struct", "recent_used_cpu");
		Show0nField(Address, "task_struct", "wake_cpu");
		Show0nField(Address, "task_struct", "on_rp");
		Show0nField(Address, "task_struct", "prio");
		Show0nField(Address, "task_struct", "static_prio");
		Show0nField(Address, "task_struct", "normal_prio");
		Show0nField(Address, "task_struct", "rt_priority");
		ShowPtr64Struct(Address, "task_struct", "sched_class", "sched_class");
		...
		ShowPtr64Struct(Address, "task_struct", "sched_task_group", "task_group");
		...
		Show0nField(Address, "task_struct", "btrace_seq");
		Show0nField(Address, "task_struct", "policy");
		Show0nField(Address, "task_struct", "nr_cpus_allowed");
		...
		Show0yField(Address, "task_struct", "sched_reset_on_fork");
		Show0yField(Address, "task_struct", "sched_contributes_to_load");
		Show0yField(Address, "task_struct", "sched_migrated");
		Show0yField(Address, "task_struct", "sched_remote_wakeup");
		Show0yField(Address, "task_struct", "sched_psi_wake_requeue");
		Show0nField(Address, "task_struct", "last_switch_count");
		Show0nField(Address, "task_struct", "last_switch_time");
	}
	if (flags & NDX_FLAG_RCU_ATTRINUTE) {
		Show0nField(Address, "task_struct", "rcu_tasks_nvcsw");
		Show0nField(Address, "task_struct", "rcu_tasks_holdout");
		Show0nField(Address, "task_struct", "rcu_tasks_idx");
		Show0nField(Address, "task_struct", "rcu_tasks_idle_cpu");
	...
	if (flags & NDX_FLAG_RELATION_ATTRINUTE) {
		...
		ShowRbNode(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "real_parent", "task_struct");
		ShowPtr64Struct(Address, "task_struct", "parent", "task_struct");
		...
		ShowListHead(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "group_leader", "task_struct");
	}
	if (flags & NDX_FLAG_PTRACE_ATTRINUTE) {
		...
		ShowListHead(Address + Offset);
		Show0nField(Address, "task_struct", "ptrace_message");
		Show0nField(Address, "task_struct", "trace_overrun");
		Show0nField(Address, "task_struct", "tracing_graph_pause");
		Show0nField(Address, "task_struct", "trace");
		Show0nField(Address, "task_struct", "trace_recursion");
		...
		ShowListHead(Address + Offset);
		Show0nField(Address, "task_struct", "curr_ret_stack");
		Show0nField(Address, "task_struct", "curr_ret_depth");
		ShowPtr64Struct(Address, "task_struct", "utask", "uprobe_task");
	}
	if (flags & NDX_FLAG_TIME_ATTRINUTE) {
		Show0nField(Address, "task_struct", "utime");
		Show0xField(Address, "task_struct", "stime");
		Show0nField(Address, "task_struct", "gtime");
		...
		Show0nField(Address, "task_struct", "nvcsw");
		Show0nField(Address, "task_struct", "nivcsw");
		Show0nField(Address, "task_struct", "start_time");
		Show0nField(Address, "task_struct", "real_start_time");
		Show0nField(Address, "task_struct", "min_flt");
		Show0nField(Address, "task_struct", "maj_flt");
		...
		ShowListHead(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "delays", "task_delay_info");

		Show0xField(Address, "task_struct", "timer_slack_ns");
		Show0nField(Address, "task_struct", "default_timer_slack_ns");
	}
	if (flags & NDX_FLAG_SIGNAL_ATTRINUTE) {
		ShowPtr64Struct(Address, "task_struct", "signal", "signal_struct");
		ShowPtr64Struct(Address, "task_struct", "sighand", "sighand_struct");

		Show0nField(Address, "task_struct", "blocked");
		Show0nField(Address, "task_struct", "real_blocked");
		Show0nField(Address, "task_struct", "saved_sigmask");

		ShowNorStruct("task_struct", "pending", "sigpending");
		GetFieldOffset("task_struct", "pending", &Offset);
		ShowSigpending(Address + Offset);

		Show0nField(Address, "task_struct", "pdeath_signal");
		ShowNorStruct("task_struct", "last_siginfo", "kernel_siginfo");//kernel_siginfo结构体内无信息
		ShowPtr64Struct(Address, "task_struct", "rseq", "rseq");

		Show0nField(Address, "task_struct", "rseq_len");
		Show0nField(Address, "task_struct", "rseq_sig");
		Show0nField(Address, "task_struct", "rseq_event_mask");
	}
	if(flags & NDX_FLAG_THREAD_GROUP_ATTRINUTE){
		ShowPtr64Struct(Address, "task_struct", "thread_pid", "pid");
		...
		ShowListHead(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "vfork_done", "completion");

		Show0xField(Address, "task_struct", "set_child_tid");
		Show0xField(Address, "task_struct", "clear_child_tid");

		ShowPtr64Struct(Address, "task_struct", "ptracer_cred", "cred");
		ShowPtr64Struct(Address, "task_struct", "real_cred", "cred");
		ShowPtr64Struct(Address, "task_struct", "cred", "cred");
	}
	if(flags & NDX_FLAG_FS_ATTRINUTE) {
		ShowPtr64Struct(Address, "task_struct", "fs", "fs_struct");
		ShowPtr64Struct(Address, "task_struct", "files", "files_struct");
		...
		ShowPtr64Struct(Address, "task_struct", "nsproxy", "nsproxy");
		Show0nField(Address, "task_struct", "sas_ss_sp");
		Show0nField(Address, "task_struct", "sas_ss_size");
		Show0nField(Address, "task_struct", "sas_ss_flags");
		Show0xField(Address, "task_struct", "journal_info");
		ShowPtr64Struct(Address, "task_struct", "nameidata", "nameidata");

		ShowPtr64Struct(Address, "task_struct", "bio_list", "bio_list");
		ShowPtr64Struct(Address, "task_struct", "io_context", "io_context");
		ShowPtr64Struct(Address, "task_struct", "plug", "blk_plug");
		ShowPtr64Struct(Address, "task_struct", "reclaim_state", "reclaim_state");
		ShowPtr64Struct(Address, "task_struct", "backing_dev_info", "backing_dev_info");
		Show0nField(Address, "task_struct", "sequential_io");
		Show0nField(Address, "task_struct", "sequential_io_avg");
		ShowPtr64Struct(Address, "task_struct", "splice_pipe", "pipe_inode_info");
		ShowPtr64Struct(Address, "task_struct", "throttle_queue", "request_queue");
	}
	if(flags & NDX_FLAG_TASK_WORK_ATTRINUTE) {
		ShowPtr64Struct(Address, "task_struct", "task_works", "callback_head");
		GetFieldOffset("task_struct", "task_works", &Offset);
		ShowCallbackHead(Address + Offset);
	}
	if (flags & NDX_FLAG_USER_ATTRINUTE) {
		ShowPtr64Struct(Address, "task_struct", "audit_context", "audit_context");

		Show0nField(Address, "task_struct", "loginuid");
		Show0xField(Address, "task_struct", "sessionid");

		ShowNorStruct("task_struct", "seccomp", "seccomp");
		GetFieldOffset("task_struct", "seccomp", &Offset);
		ShowSeccomp(Address + Offset);

		Show0nField(Address, "task_struct", "parent_exec_id");
		Show0nField(Address, "task_struct", "self_exec_id");
		ShowPtr64Struct(Address, "task_struct", "cgroups", "css_set");
		ShowNorStruct("task_struct", "cg_list", "list_head");
		GetFieldOffset("task_struct", "cg_list", &Offset);
		ShowListHead(Address + Offset);
		Show0nField(Address, "task_struct", "jobctl");
		Show0nField(Address, "task_struct", "personality");
		Show0nField(Address, "task_struct", "patch_state");
		Show0xField(Address, "task_struct", "security");
	}
	if (flags & NDX_FLAG_LOCK_ATTRINUTE) {
		Show0yField(Address, "task_struct", "in_execve");
		Show0yField(Address, "task_struct", "in_iowait");
		Show0yField(Address, "task_struct", "restore_sigmask");
		Show0yField(Address, "task_struct", "in_user_fault");
		Show0yField(Address, "task_struct", "no_cgroup_migration");
		Show0yField(Address, "task_struct", "use_memdelay");
		Show0nField(Address, "task_struct", "atomic_flags");
		...
		ShowPtr64Struct(Address, "task_struct", "pi_top_task", "task_struct");
		ShowPtr64Struct(Address, "task_struct", "pi_blocked_on", "rt_mutex_waiter");
		...
		ShowListHead(Address + Offset);
		ShowPtr64Struct(Address, "task_struct", "pi_state_cache", "futex_pi_state");
		ShowPtr64Struct(Address, "task_struct", "robust_list", "robust_list_head");
		ShowPtr64Struct(Address, "task_struct", "compat_robust_list", "compat_robust_list_head");
	...
	if (flags & NDX_FLAG_X86_ATTRINUTE) {
		Show0nField(Address, "task_struct", "closid"); // rdt
		Show0nField(Address, "task_struct", "rmid");
	}
	if (flags & NDX_FLAG_MM_ATTRINUTE) {
		Show0nField(Address, "task_struct", "psi_flags");
		Show0nField(Address, "task_struct", "acct_rss_mem1");
		Show0nField(Address, "task_struct", "acct_vm_mem1");
		Show0nField(Address, "task_struct", "acct_timexpd");
		...
		Show0nField(Address, "task_struct", "cpuset_mem_spread_rotor");
		Show0nField(Address, "task_struct", "cpuset_slab_spread_rotor");

		ShowPtr64Struct(Address, "task_struct", "oom_reaper_list", "task_struct");
		ShowPtr64Struct(Address, "task_struct", "stack_vm_area", "vm_struct");
		ShowPtr64Struct(Address, "task_struct", "memcg_in_oom", "mem_cgroup");//

		Show0nField(Address, "task_struct", "memcg_oom_gfp_mask");
		Show0nField(Address, "task_struct", "memcg_oom_order");
		Show0nField(Address, "task_struct", "memcg_nr_pages_over_high");

		ShowPtr64Struct(Address, "task_struct", "active_memcg", "mem_cgroup");
		Show0nField(Address, "task_struct", "pagefault_disabled");
		Show0nField(Address, "task_struct", "stack_refcount");
		Show0nField(Address, "task_struct", "nr_dirtied");
		Show0nField(Address, "task_struct", "nr_dirtied_pause");
		Show0nField(Address, "task_struct", "dirty_paused_when");
	...
	if(flags & NDX_FLAG_NUMA_ATTRINUTE){
		Show0nField(Address, "task_struct", "numa_scan_seq");
		Show0xField(Address, "task_struct", "numa_scan_period");
		Show0nField(Address, "task_struct", "numa_scan_period_max");
		Show0nField(Address, "task_struct", "numa_preferred_nid");
		Show0nField(Address, "task_struct", "numa_migrate_retry");
		Show0nField(Address, "task_struct", "node_stamp");
		Show0nField(Address, "task_struct", "last_task_numa_placement");
		Show0nField(Address, "task_struct", "last_sum_exec_runtime");

		ShowNorStruct("task_struct", "numa_work", "callback_head");
		GetFieldOffset("task_struct", "numa_work", &Offset);
		ShowCallbackHead(Address + Offset);

		ShowPtr64Struct(Address, "task_struct", "numa_group", "numa_group");

		Show0xField(Address, "task_struct", "numa_faults");
		Show0nField(Address, "task_struct", "total_numa_faults");
		ShowArrayField(Address, "task_struct", "numa_faults_locality");
		Show0nField(Address, "task_struct", "numa_pages_migrated");
		Show0nField(Address, "task_struct", "il_prev");
		Show0nField(Address, "task_struct", "pref_node_fork");
		ShowPtr64Struct(Address, "task_struct", "mempolicy", "mempolicy");
	}
...
DECLARE_API(lxp)
{
	...
	char option[256], comm_filter[100];
	ULONG  Offset;
	...
	GetFieldOffset("task_struct", "tasks", &Offset);
	do {
		ShowTaskStruct(Address, pid, comm_filter, flags);
		if (desired_task_addr != 0) {
			break;
		}
